...
hidden char *__nl_langinfo_l(nl_item item, locale_t loc)
{
    switch (item)
    {
        case CODESET: return loc->is_utf8? "UTF-8" : "ASCII";
        ...
        case ERA: return "";
        case ERA_D_FMT: return "%m/%d/%y";
        case ERA_D_T_FMT: return "%a %b %e %H:%M:%S %Y";
        case ERA_T_FMT: return "%H:%M:%S";
        case ALT_DIGITS: return "0123456789";
