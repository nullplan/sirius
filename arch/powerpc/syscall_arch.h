...
static inline long __syscall0(long nr)
{
    ...
    __asm__ volatile("sc; bns 1f; neg 3,3; 1:" : "+r"(r0), "=r"(r3) :: "r4","r5","r6","r7","r8","r9","r10","r11","r12","cr0","memory");
    return r3;
}
...
static inline long __syscall2(long nr, long a, long b)
{
    ...
    __asm__ volatile("sc; bns 1f; neg 3,3; 1:" : "+r"(r0), "+r"(r3), "+r"(r4) :: "r5","r6","r7","r8","r9","r10","r11","r12","cr0","memory");
    return r3;
}
...
static inline long __syscall3(long nr, long a, long b, long c)
{
    ...
    __asm__ volatile("sc; bns 1f; neg 3,3; 1:" : "+r"(r0), "+r"(r3), "+r"(r4), "+r"(r5) :: "r6","r7","r8","r9","r10","r11","r12","cr0","memory");
    return r3;
}
...
static inline long __syscall4(long nr, long a, long b, long c, long d)
{
    ...
    __asm__ volatile("sc; bns 1f; neg 3,3; 1:" : "+r"(r0), "+r"(r3), "+r"(r4), "+r"(r5), "+r"(r6) :: "r7","r8","r9","r10","r11","r12","cr0","memory");
    return r3;
}
...
static inline long __syscall5(long nr, long a, long b, long c, long d, long e)
{
    ...
    __asm__ volatile("sc; bns 1f; neg 3,3; 1:" : "+r"(r0), "+r"(r3), "+r"(r4), "+r"(r5), "+r"(r6), "+r"(r7) :: "r8","r9","r10","r11","r12","cr0","memory");
    return r3;
}
