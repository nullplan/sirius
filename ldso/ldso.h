...
hidden int __reloc_all(struct dso *, int (*)(const char *, ...));
hidden int __relocate(struct dso *, int (*)(const char *, ...));
hidden void __decode_vec(size_t *, const size_t *, size_t);
hidden struct dso *__dl_head(void);
hidden struct dso *__dl_tail(void);
hidden void __dl_restore_tail(struct dso *);
...
hidden struct dso **__queue_initializers(struct dso *, int (*)(const char *, ...));
hidden void __dl_push_back(struct dso *);
hidden void __queue_main_initializers(struct dso *, int (*)(const char *, ...));
hidden void *__map_library(int, struct dso *, int (*)(const char *, ...));
hidden int __load_deps(struct dso *dso, const char *search_path, int at_startup, int (*)(const char *, ...));
hidden void __load_preload(char *preload, const char *search_path, int (*)(const char *, ...));
hidden struct dso *__load_library(const char *name, const char *search_path, int at_startup, int (*)(const char *, ...));
...
hidden void *__dlsym(void *__restrict, const char *__restrict, uintptr_t);
#endif
